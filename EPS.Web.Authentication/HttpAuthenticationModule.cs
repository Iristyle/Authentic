...
namespace EPS.Web.Authentication
{
	...
	public class HttpAuthenticationModule : HttpModuleBase
	{
		...
		private static Func<HttpAuthenticationModule, IModuleConfiguration> _configure;
		...
		public static Func<HttpAuthenticationModule, IModuleConfiguration> Configure
		{
