...
namespace EPS.Web.Authentication
{
	...
	public class SimpleFailureHandlerFactory :
				FailureHandlerFactoryBase<FailureHandlerConfiguration>
	{
		...
		public override IFailureHandler<FailureHandlerConfiguration> Construct(
			FailureHandlerConfiguration config)
		{
