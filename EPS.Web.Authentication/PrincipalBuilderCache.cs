...
{
    /// <summary>   This class manages construction of IPrincipalBuilder instances given a <see cref="T:IHttpContextInspectingAuthenticatorConfigurationElement"/> instance.
    /// 			This is effectively a service locator.
    /// 			 Principal builder cache. </summary>
    /// <remarks>   ebrown, 4/7/2011. </remarks>
    public static class PrincipalBuilderCache
    {
        ...
        public static IPrincipalBuilder Resolve(IHttpContextInspectingAuthenticatorConfigurationElement configuration)
        {
