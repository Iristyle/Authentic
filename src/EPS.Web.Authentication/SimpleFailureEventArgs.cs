...
namespace EPS.Web.Authentication
{
	...
	public class SimpleFailureEventArgs : EventArgs
	{
		...
		public IFailureHandlerConfiguration Config { get; private set; }
		...
		/// <summary>	Gets or sets a value indicating whether we should terminate the request. </summary>
		/// <value>	true to terminate the request, false if not. </value>
